...
- `-i` argument is a space separated list of paths to the `data_processed` folders (generated by the `comparison_with_other_methods_<sc/lesion>.sh` script) containing the spinal cord predictions. 
